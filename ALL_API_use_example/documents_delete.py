...
def delete_document(
    doc_id, api_url="http://localhost:9621/documents/delete_document", api_key="null"
):
    """
    删除指定ID的文档
    ...
    """
    # 准备请求参数
    params = {"api_key_header_value": api_key}

    # 准备请求体
    data = {"doc_ids": [doc_id], "delete_file": False, "delete_llm_cache": False}
