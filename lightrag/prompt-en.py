...
7. Feedback & Learning (Critical):
  - Below are recent user feedback records.
  - **Negative Feedback (Dislike)** indicates what you should AVOID or CORRECT.
  - **Positive Feedback (Like)** indicates the style or format you should MAINTAIN.
  {feedback_context}
