                ...
                <div className="flex items-center gap-4 rounded-xl border border-gray-100 bg-white p-4 shadow-sm">
                    ...
                    <div>
                        ...
                        <div className="text-lg font-bold text-gray-800">
                            45.2 MB{' '}
                            <span className="text-xs font-normal text-gray-400">/ 500 MB</span>
                        </div>
                    </div>
                </div>
                <div className="flex items-center gap-4 rounded-xl border border-gray-100 bg-white p-4 shadow-sm">
                        ...
                        filteredDocs.map((doc) => (
                            ...
                            >
                                ...
                                >
                                    <div
                                        className="relative"
                                        ref={activeMenuDocId === doc.id ? menuRef : null}
                                    >
                                        <button
                                            onClick={(e) => {
                                                e.stopPropagation()
                                        ...
                                        {activeMenuDocId === doc.id && (
                                            <div className="animate-in fade-in zoom-in-95 absolute top-full right-0 z-20 mt-1 w-32 origin-top-right rounded-lg border border-gray-100 bg-white py-1 shadow-xl duration-200">
                                                <button
                                                    onClick={(e) =>
                                                        handleMenuAction(e, 'rename', doc.id)
                                                    }
                                                ...
                                                <button
                                                    onClick={(e) =>
                                                        handleMenuAction(e, 'download', doc.id)
                                                    }
                                                    className="flex w-full items-center gap-2 px-3 py-2 text-left text-xs text-gray-700 hover:bg-gray-50"
                                                >
                                                ...
                                                <button
                                                    onClick={(e) =>
                                                        handleMenuAction(e, 'share', doc.id)
                                                    }
                                                    className="flex w-full items-center gap-2 px-3 py-2 text-left text-xs text-gray-700 hover:bg-gray-50"
                                                >
                                                ...
                                                <button
                                                    onClick={(e) =>
                                                        handleMenuAction(e, 'delete', doc.id)
                                                    }
