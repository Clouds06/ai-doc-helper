...
describe('sanitizeQuery', () => {
  ...
  describe('防注入', () => {
    it('应移除英文 ignore/forget/disregard/do not follow instructions', () => {
...
describe('getSampleStatus', () => {
  ...
  it('应返回 fail 当 answer_relevancy 不足', () => {
    const metrics: RagasMetrics = {
      faithfulness: 0.8,
